...
const AboutContent = () => {
  ...
  return (
    <div
      className={`w-full p-2 pt-0 mb-20 mob:p-8`}
    >
      <h1 className="text-2xl tablet:text-3xl">Welkom bij De Vlietlanden</h1>
      <p className="mt-5 opacity-50 text-lg tablet:text-xl">
